...
def main() -> int:
    parser = argparse.ArgumentParser(description="RMR Global v5.3.1 final production corrections browser Golden Paths")
    parser.add_argument("--base-url", default="http://127.0.0.1:18155")
    parser.add_argument("--output-dir", default="qa/screenshots-v531-final-corrections")
    parser.add_argument("--result", default="qa/V531-FINAL-CORRECTIONS-BROWSER-GOLDEN-PATHS.json")
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            won_name = f"V531 Won {async_marker}"
            lost_name = f"V531 Lost {async_marker}"
            ...
            def create_opportunity(name: str, value: str, probability: str) -> None:
                ...
                page.fill('#v53-new-form [name="next_action"]', "Complete v5.3.1 Product Owner review")
